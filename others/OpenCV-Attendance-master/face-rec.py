...
def isMatch(filename1,filename2):
	img1 = cv2.cvtColor(fr.load_image_file(filename1),cv2.COLOR_BGR2RGB)
	img2 = cv2.cvtColor(fr.load_image_file(filename2),cv2.COLOR_BGR2RGB)
